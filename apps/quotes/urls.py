...
urlpatterns = [
    ...
    path("preventivi/<int:pk>/riprendi/", views.quote_resume, name="resume"),
    path("preventivi/<int:pk>/dati/", views.quote_general, name="general"),
    path("preventivi/<int:pk>/articoli/", views.quote_items, name="items"),
    path("preventivi/<int:pk>/articoli/ultima-versione/", views.item_latest_version, name="item_latest_version"),
    ...
    path("preventivi/archivia-selezionati/", views.quote_bulk_archive, name="bulk_archive"),
    path("preventivi/ripristina-selezionati/", views.quote_bulk_restore, name="bulk_restore"),
